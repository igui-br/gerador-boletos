...
var Boleto = (function() {
	//var DATA_BASE = new Date(1997, 10 - 1, 7); // Até 21/02/2025
	//De 22/02/2025 até 13/10/2049 -> new Date(2022, 5 - 1, 29)
	var DATA_BASE = this.getDatas().getVencimento() >= new Date(2025, 2 - 1, 22) ? new Date(2022, 5 - 1, 29) : new Date(1997, 10 - 1, 7);
