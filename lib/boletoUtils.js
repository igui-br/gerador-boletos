...
var Datas = (function() {
	...
	Datas.prototype.comDocumento = function(_documento) {
		...
		if(!validarData(_documento)) {
			throw new Error('O ano do documento deve ser maior que 1997 e menor que 2049');
		}
...
var Boleto = (function() {
	...
	Boleto.prototype.getFatorVencimento = function() {
		var vencimento = this.getDatas().getVencimento(),
			DATA_BASE = vencimento >= new Date(2025, 2 - 1, 22) ? new Date(2022, 5 - 1, 29) : new Date(1997, 10 - 1, 7) // https://documentacao.senior.com.br/noticias/2025/2025-01-29-fator-vencimento-febraban.htm
			diferencaEmDias = (vencimento - DATA_BASE) / (1000 * 60 * 60 * 24);

		if(Math.floor(diferencaEmDias) > 9999) {
	...
	Boleto.prototype.getPixQRCode = function() {
		return this._pixQRCode;
	}

	Boleto.prototype.comPixQRCode = function(_pixQRCode) {
		this._pixQRCode = _pixQRCode;
		return this;
	}
